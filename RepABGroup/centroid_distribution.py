...
def create_subplot(data, bins, group ,ax=None):
    ...
    ax.set_title('Group ' + group + ' centroid distance')
    ax.set_xlabel('Bins')
...
## set path 
inputPath = '/san/home/yunfeng.hu/Chemistry/all_64rep_centroid_20170714/centroid_distance/'
outputPath = '/san/home/yunfeng.hu/Chemistry/all_64rep_centroid_20170714/'
os.chdir(outputPath)
...
plt.tight_layout()
plt.savefig('CentroidDistanceHistogram'+'.png')
